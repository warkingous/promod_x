...
// {
// 	if( isDefined( game["PROMOD_MATCH_MODE"] ) && game["PROMOD_MATCH_MODE"] == "match" && level.gametype == "sd" && game["PROMOD_KNIFEROUND"] == 0 && level.match_id != 0 && level.track_pub_stats == 1 )
// 	{
...
onUsePlantObject( player )
{
	...
	if ( !self maps\mp\gametypes\_gameobjects::isFriendlyTeam( player.pers["team"] ) )
	{
		...
		if( isDefined( game["PROMOD_MATCH_MODE"] ) && game["PROMOD_MATCH_MODE"] == "match" && game["PROMOD_KNIFEROUND"] == 0 && level.match_id != 0 ) // && level.gametype == "sd"
		{
