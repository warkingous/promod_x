...
validClass( classType, preServed, type )
{
	...
	loadout_camo = strTok( "camo_none,camo_brockhaurd,camo_bushdweller,camo_blackwhitemarpat,camo_tigerred,camo_stagger,camo_gold,camo_twotone,camo_dark,camo_asiimov,camo_x,camo_secret", "," );
	loadout_secondary_camo = strTok( "camo_none,camo_gold,camo_twotone,camo_dark,camo_asiimov,camo_x,camo_secret", "," );
