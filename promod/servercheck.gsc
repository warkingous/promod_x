...
errorMessage()
{
	...
	for(;;)
	{
		...
		if( isDefined( game["PROMOD_MATCH_MODE"] ) && game["PROMOD_MATCH_MODE"] == "match" || toLower( getDvar( "fs_game" ) ) == "mods/fps_promod_271" )
		{
			if( toLower(getDvar("fs_game")) != "mods/fps_promod_271" )
